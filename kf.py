...
# Logo of K-fuscator
logo=f'''
{green} masukkan file dengan nama bahan.sh lalu pilih nomer 6
...
{purple} hasil decrypt otomatis tersimpan dengan nama hasil.sh                         
...
def about():
    os.system("clear")
    print(f"{cyan}[Done.....]  {purple} :[ Hasil decrypt nya adalah hasil.sh]")
    os.system("bash anu.sh")
    sprint(logo, 0.01)
...
def main():
    ...
    print(f"{green}[6]{yellow} Decrypt-bashrock-about")
